  ...
  return (
    ...
    >
      ...
      <div className="relative z-20 px-4 text-center">
        ...
        >
          <Terminal className="w-24 h-24 mx-auto text-green-500 md:w-32 md:h-32" />
        </motion.div>
        ...
        <a href="https://t.me/Linux_Users_Club">
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            className="px-8 py-3 text-lg font-bold text-black transition-all duration-300 rounded-full bg-gradient-to-r from-green-500 to-blue-500 hover:from-green-400 hover:to-blue-400"
          >
            Join Us
          </motion.button>
        </a>
